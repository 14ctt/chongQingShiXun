...
<body body style="background-color:transparent" bgColor="transparent" >
<form action="${webtxc}/home/goods/update.do" method="post">
		<div class="r_price">
<br>
<h2>请输入品牌信息</h2>
		<div class="p_form">
...
图&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;片:<input id="image" name="image" type="file" accept=".png,.gif,.jpeg"/><br/>
